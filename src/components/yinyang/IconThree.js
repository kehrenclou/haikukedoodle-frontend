  ...
  >
    <defs>
      <style>
        {".colorA{fill:#000}"}
        {".colorB{fill:#FFF}"}
        {".colorC{fill-opacity:0}"}

        {".cls-2,.cls-3,.cls-4{isolation:isolate}"}
        {".cls-2{fill:#000}"}
        {".cls-6{letter-spacing:.06em}"}
        {".cls-3{fill:#fff}"}
        {".cls-3,.cls-4{font-family:Montserrat,Arial;font-size:48px}"}
      </style>
    </defs>

    <a className="icon-link" onClick={() => console.log("clicked-light")}>
      <g id="Light">
        <g id="yy-light" className="lobe__light">
          <Lobe
            lobecolor="colorB"
        ...
        {/* </a> */}
        <g id="text-dark" className="cls-2 colorA">
          <text className="cls-4 " transform="matrix(.77 0 0 1 414.05 236.25)">
            <tspan x={0} y={0}>
              {"CREATE"}
            </tspan>

            <tspan xmlSpace="preserve" x={191.13} y={0} className="cls-6">
              {" A"}
            </tspan>
          </text>
          <text className="cls-4 " transform="matrix(.77 0 0 1 390.89 293.08)">
            <tspan x={0} y={0}>
              {"HAIKU SONG"}
            </tspan>
          </text>
    ...
    <a className="icon-link" onClick={() => console.log("clicked-dark")}>
      <g id="dark">
        <g id="uyy-dark" data-name="yy-dark">
          <Lobe
            lobeColor="ColorA"
        ...
        <g
          id="text-light"
          className="cls-3"
          data-name="uuid-524dfe5a-0264-4c8a-b08b-ff9dc6eb6c78"
        >
          <text className="" transform="matrix(.77 0 0 1 130.84 456.07)">
            <tspan x={0} y={0}>
              {"READ"}
            </tspan>
            <tspan xmlSpace="preserve" x={133.36} y={0} className="cls-6">
              {" A"}
            </tspan>
            <tspan x={173.41} y={0} />
          </text>
          <text className="" transform="matrix(.77 0 0 1 89.88 512.76)">
            <tspan x={0} y={0}>
              {"HAIKU SONG"}
            </tspan>
          </text>
